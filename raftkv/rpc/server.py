...
class RPCHandler(BaseHTTPRequestHandler):
    ...
    def do_OPTIONS(self):
        # CORS preflight support -- lets a browser-based dashboard (running
        # on a different origin, e.g. a Vite dev server) call these HTTP
        # endpoints directly without being blocked by browser security.
